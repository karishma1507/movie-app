<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mystery.aspx.cs" Inherits="movie_app.mystery" %>
...
<body>
    <form id="form1" runat="server">
     ...
     <asp:Label ID="Label1" runat="server" ForeColor="#FFCCFF" 
        ...
        <asp:Image ID="Image1" runat="server" ImageUrl="~/pic/images (11).jpeg" 
        ...
        <asp:Label ID="Label6" runat="server" ForeColor="White" 
         ...
         <asp:Label ID="Label8" runat="server" ForeColor="#CCCCCC" 
             Text="A single mom named Gabbie hires a tour guide, a psychic, a priest and a historian to help exorcise her newly bought mansion after discovering it is inhabited by ghosts." 
             style="font-size: large; z-index: 1; left: 634px; top: 235px; position: absolute; width: 464px"></asp:Label>
            </div>
    </form>
</body>
</html>
