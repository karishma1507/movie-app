<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="iamnumfour.aspx.cs" Inherits="movie_app.iamnumfour" %>
...
<body>
    <form id="form1" runat="server">
     ...
     <asp:Label ID="Label1" runat="server" ForeColor="#FFCCFF" 
        ...
        <asp:Image ID="Image1" runat="server" ImageUrl="~/pic/images (15).jpeg" 
        ...
        <asp:Label ID="Label2" runat="server" ForeColor="White" 
            ...
            Text="IAM NUMBER FOUR"></asp:Label>
        ...
        <asp:Label ID="Label6" runat="server" ForeColor="White" 
            ...
            <asp:Label ID="Label7" runat="server" ForeColor="#CCCCCC" Text="6.1/10" 
         ...
         <asp:Label ID="Label8" runat="server" ForeColor="#CCCCCC" 
             ...
             style="font-size: large; z-index: 1; left: 630px; top: 235px; position: absolute; width: 444px"></asp:Label>
            </div>
    </form>
</body>
</html>
