<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gladiathor.aspx.cs" Inherits="movie_app.gladiathor" %>
...
<body>
    <form id="form1" runat="server">
     ...
     <asp:Label ID="Label1" runat="server" ForeColor="#FFCCFF" 
        ...
        <asp:Image ID="Image1" runat="server" ImageUrl="~/pic/images (14).jpeg" 
        ...
        <asp:Label ID="Label6" runat="server" ForeColor="White" 
            ...
            <asp:Label ID="Label7" runat="server" ForeColor="#CCCCCC" Text="8.5/10" 
             style="z-index: 1; left: 640px; top: 415px; position: absolute"></asp:Label>
         <asp:Label ID="Label8" runat="server" ForeColor="#CCCCCC" 
             Text="A former Roman General sets out to exact vengeance against the corrupt emperor who murdered his family and sent him into slavery." 
             style="font-size: large; z-index: 1; left: 630px; top: 235px; position: absolute; width: 450px"></asp:Label>
            </div>
    </form>
</body>
</html>
