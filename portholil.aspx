<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="portholil.aspx.cs" Inherits="movie_app.portholil" %>
...
<body>
    <form id="form1" runat="server">
     ...
     <asp:Label ID="Label1" runat="server" ForeColor="#FFCCFF" 
        ...
        <asp:Image ID="Image1" runat="server" ImageUrl="~/pic/images (17).jpeg" 
        ...
        <asp:Label ID="Label6" runat="server" ForeColor="White" 
            ...
            <asp:Label ID="Label7" runat="server" ForeColor="#CCCCCC" Text="8/10" 
             style="z-index: 1; left: 640px; top: 425px; position: absolute"></asp:Label>
         <asp:Label ID="Label8" runat="server" ForeColor="#CCCCCC" 
             Text="A bright but faint-hearted rookie cop has to overcome his fears in order to succeed in his first case which sees him partnered with a reclusive senior officer to catch a serial killer on the loose." 
             style="font-size: large; z-index: 1; left: 614px; top: 235px; position: absolute; width: 492px"></asp:Label>
            </div>
    </form>
</body>
</html>
