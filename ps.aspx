<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ps.aspx.cs" Inherits="movie_app.ps" %>
...
<body>
    ...
    <div style="background-image: url('pic/bg1.jpg'); height: 927px; width: 1610px;">
     ...
     <asp:Label ID="Label1" runat="server" ForeColor="#FFCCFF" 
        ...
        <asp:Image ID="Image1" runat="server" ImageUrl="~/pic/images (24).jpeg" 
        ...
        <asp:Label ID="Label2" runat="server" ForeColor="White" 
            ...
            Text="PONNIYIN SELVAN"></asp:Label>
        ...
        <asp:Label ID="Label4" runat="server" ForeColor="White" 
            style="z-index: 1; left: 640px; top: 336px; position: absolute" 
        ...
        <asp:Label ID="Label6" runat="server" ForeColor="White" 
            ...
            Text="Vandiyathevan crosses the Chola land to deliver a message from the Crown Prince Aditha Karikalan, while Kundavai attempts to establish political peace as vassals and petty chieftains plot against the throne." 
            style="z-index: 1; left: 600px; top: 235px; position: absolute; width: 497px; font-size: large"></asp:Label>
         <asp:Label ID="Label8" runat="server" ForeColor="#CCCCCC" Text="7.6/10" 
            style="z-index: 1; left: 640px; top: 385px; position: absolute"></asp:Label>
            </div>
    </form>
</body>
</html>
